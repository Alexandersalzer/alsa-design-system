/**
 * @deprecated This file is deprecated. Use utils/loaders.ts instead.
 * All functions have been moved to utils/loaders.ts with the new
 * structure/content separation system.
 * 
 * New functions:
 * - getPageWithContent(pageSlug, locale) - replaces getPageContent
 * - getShellWithContent(shellType, locale) - replaces getShellContent
 * - getNavbarContent(locale) - same name, new implementation
 * - getFooterContent(locale) - same name, new implementation
 */
